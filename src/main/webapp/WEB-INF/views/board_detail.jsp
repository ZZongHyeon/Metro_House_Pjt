...
<link rel="stylesheet" type="text/css"
	href="/resources/css/board_detail.css">
<link rel="stylesheet"
		...
		<div class="board-container">
				...
				<div class="board-header">
					...
					<div class="board-meta">
							...
							<div class="author-details">
								...
								<div class="post-date">
									...
									<c:if test="${not empty dateStr}">
										...
										<c:if test="${fn:length(formattedDate) > 10}">
											<c:set var="formattedDate" value="${fn:substring(formattedDate, 0, 10)}" />
										</c:if>
										${formattedDate}
									</c:if>
								</div>
						...
						<div class="post-info">
							...
							<div class="info-item">
								<i class="fas fa-heart"></i> <span id="like-count">${board.boardLikes}</span>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="comments-section">
				<h2 class="comments-header">
					...
					<span class="comment-count">${commentList.size()}</span>
				</h2>
