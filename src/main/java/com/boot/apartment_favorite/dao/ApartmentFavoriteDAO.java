...
public interface ApartmentFavoriteDAO {
	...
	public int checkFavoriteList(int userNumber, HashMap<String, Object> param); // 검증(이미 눌렀으면) select

	public int removeFavoriteList(@Param("userNumber") int userNumber,@Param("favoriteId") int favoriteId, @Param("param")HashMap<String, String> param); // 삭제(관심아파트 페이지에서 하트눌렀을 때) delete
